...
Generated by `make_report.py` from `results.json`. Animal `AT-B1NO1`, booth 1 (high=50, open>5000). Companion to [`REPORT_accuracy.md`](REPORT_accuracy.md) (Report 1, online-vs-offline reliability across both booths).
